...
struct Telegram {
	...
	Telegram(double time, unsigned int sender, unsigned int receiver, int msg, void* info = NULL)
		: dispatch_time(time), sender(sender), receiver(receiver), msg(msg), extra_info(info) {}
